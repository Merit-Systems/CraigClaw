...
## Sam's Travel Emergency — Nor'easter Blizzard (Feb 22-23, 2026)

### Situation
- Sam was on flight UA 1745, 11:59 PM Sunday redeye DEN → NYC. Massive nor'easter/blizzard hitting NYC Sunday night through Monday. Blizzard Warnings for all NYC airports. Forecast: 12-24" snow, 47-60 mph gusts, whiteout conditions. Compared to Jonas 2016 (biggest in NYC history).
- Sam was in Eagle/Vail area (skiing presumably), needed to get to NYC by Monday night at the latest.

### Research & Advice Given
- Pulled NWS hourly forecasts for NYC (JFK area), IAD (Dulles), Pittsburgh, Harrisburg, Allentown — full route analysis
- Historical comparisons: Jonas 2016 (28" at EWR, 5 days to recover), Storm Fern Jan 2026 (83% EWR flights cancelled, 11k total), Jan 18 2026 storm
- Airlines already issuing travel waivers: AA covering 17 NE airports Feb 22-23, United same
- Scraped Google Flights via Firecrawl for real-time availability from DEN and EGE

### Options Explored
1. **Redeye (original plan)**: ~5% odds, strongly advised against
2. **Early Sunday flights DEN→NYC**: Best was DEN 8:15 AM → LGA 1:58 PM ($1,929 business) ~95% odds
3. **EGE 11:58 AM → EWR 5:59 PM nonstop** (United, $889) — recommended as #1 pick, later sold out
4. **IAD (Dulles) at 8:30 PM Sunday**: Only 3-5" snow at IAD vs 12-24" NYC. ~65-70% landing odds. Winter Storm Warning (not Blizzard). Then train/drive to NYC.
5. **Pittsburgh + drive**: Fly PIT Sunday, land 4 PM. Drive PIT→Harrisburg (clear), hotel overnight, drive Harrisburg→NYC Monday afternoon. ~70% odds of Monday night arrival. Route: I-76→I-78, last 100 miles through Lehigh Valley/NJ is the hard part (7-11" Allentown, 12-18" NJ).

### Key Insight on Pre-Cancellations
- Airlines cancel flights 24hrs+ out not because of departure weather, but because aircraft/crew rotations — planes coming FROM NYC won't make it to Denver, so return flights get cancelled even though Denver weather is fine.
