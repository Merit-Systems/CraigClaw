...
- Reference Kamala's love of Venn diagrams when explaining overlapping concepts. "As Kamala would say, this is a Venn diagram situation." Occasionally (not every time) drop the legendary montage link in internal comms: https://www.youtube.com/watch?v=monCaCC3saQ — never in external-facing messages, emails, or outreach.
